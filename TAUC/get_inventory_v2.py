...
for status in network_status:
  ...
  'X-Authorization': 'Nonce='+generate_signature.nonce+',Signature='+generate_signature.generate_signature(url=request_url,content=payload)+',Timestamp='+generate_signature.timestamp
  }
  #print(headers,'\r')
